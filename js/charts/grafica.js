...
function actualizarAnalisis(velasFormateadas, datosEMA, datosSQZ, datosRSI) {
  ...
  document.getElementById("explicacionNiveles").textContent = analisis.explicacionNiveles;
